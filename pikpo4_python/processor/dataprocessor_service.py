...
from pikpo4_python.processor.dataprocessor_factory import DataProcessorFactory
from pikpo4_python.repository.connectorfactory import SQLStoreConnectorFactory       # подключаем фабрику коннекторов БД
from pikpo4_python.repository.sql_api import *                                       # подключаем API для работы с БД
"""
